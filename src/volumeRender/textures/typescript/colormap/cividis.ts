 ...
 *
 * tinycolormap.hpp
 * @link https://github.com/yuki-koyama/tinycolormap/blob/d75a66dd4ba8469eadadb953a843aa2cc4dc357c/include/tinycolormap.hpp#L1893
 */

import { CalcLerp } from "../utils";

export function GetCividisColor(x: number)
{
    const data =
    [
