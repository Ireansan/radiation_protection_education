...
import { RigidBody, RigidBodyApi, CuboidCollider, CuboidArgs } from "@react-three/rapier";
 ...
 */
export const DoseBoardControls = React.forwardRef<DoseControlsImpl, DoseBoardControlsProps>(
    function DoseBoardControls(
        ...
        const [set, debug, viewing] = useStore((state) => [state.set, state.debug, state.viewing]);
        ...
        function onDrag(
            ...
            if (helperRef.current) {
                ...
                for (let i = 0; i < table.length; i++) {
                    ...
                    Planes[tmp.index].constant = -Positions[tmp.index].dot(Normals[tmp.index]);
