    ...
    return (
        <>
            ...
            >
                ...
                <p>
                    {/* FIXME: */}
                    When the data display format is <code>time lapse</code>,
                ...
                <ul>
                    ...
                    <li>
                        <code>speed</code>: playback speed (selectable from
                        <code>0.25</code>, <code>0.5</code>, <code>1</code>,{" "}
                        <code>1.5</code>, <code>2</code>, <code>8</code>,{" "}
                        <code>16</code>)
                    </li>
                    <li>
        ...
        <>
            ...
            >
                ...
                <ul>
                    ...
                    <li>
                        <code>colormap</code>: colormap to be applied to the
                        data
                    </li>
                    <li>
                        <code>renderstyle</code>: the rendering style (you can
                        choose between <code>mip</code> (Maximum Intensity
                        Projection) and
                        <code>iso</code> (Isosurface))
                    </li>
                    <li>
                        <code>isothreshold</code>: the lower threshold to be
                        rendered (this is reflected only when{" "}
